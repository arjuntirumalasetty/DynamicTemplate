package com.medicea.util;

/**
 * Created by Arjun on 6/18/2017.
 */
...
public class AmazonS3Template {
    ...
    /*public AmazonS3Template() {
        ...
        this.accessKeyId = amazonProperties.getAws().getAccessKeyId();
        this.accessKeySecret = amazonProperties.getAws().getAccessKeySecret();
    }*/
